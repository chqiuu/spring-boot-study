package com.chqiuu.study.oauth2.sso.resource;
...
public class OAuth2ResourceServerApplication {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(OAuth2ResourceServerApplication.class, args);
