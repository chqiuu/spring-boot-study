package com.chqiuu.study.oauth2.sso.authorization;
...
public class OAuth2AuthorizationServerApplication {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(OAuth2AuthorizationServerApplication.class, args);
